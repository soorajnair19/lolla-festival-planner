                      ...
                      return (
                        ...
                        >
                          <div className="p-2 md:p-3 h-full flex flex-col justify-between">
                            <span className={`${selected ? 'text-white' : dayColors.defaultCardText} text-[10px] md:text-xs font-semibold leading-tight break-words`}>
                              {slot.artist}
                            </span>
                            <div className="flex items-center justify-between mt-1">
                              <span className={`${selected ? 'text-white' : 'text-black'} text-xs`}>
                                {slot.time}
                              </span>
                              {selected && (
